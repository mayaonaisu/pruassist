...
const CANONICAL: Record<string, string[]> = {
  ...
  "PRUShield Premier": ["pru shield premier", "prushield premier", "peru shield premier", "pro shield premier", "pool shield premier", "blue shield premier"],
  "PRUShield Standard": ["pru shield standard", "prushield standard", "peru shield standard", "pro shield standard", "pool shield standard", "blue shield standard"],
  "PRUShield Plus": ["pru shield plus", "prushield plus", "peru shield plus", "pro shield plus", "pool shield plus", "blue shield plus"],
  ...
  "PRUShield": ["pru shield", "prue shield", "peru shield", "true shield", "crew shield", "prew shield", "pru she'll", "pro shield", "pool shield", "blue shield", "pru-shield", "prushield"],
